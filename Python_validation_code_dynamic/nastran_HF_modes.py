...
if __name__ == "__main__":
    ...
    user_input = input('Enter the case name\n')
    ...
    user_input3 = 'dynamic_HF'+ user_input
    ...
    root.add('structures', NastranDynamic(node_id_all, template_file, output_file, tn, mn, sn, an, M, eigr , 0.,35.), promotes=['*'])
